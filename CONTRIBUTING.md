...
| Whole NT oracle | `PYTHONPATH=$PWD/src python3 tools/golden/sblgnt_nt_driver.py tools/golden/data tools/golden/work/nt` | 6,921 source = 6,797 compared + 61 refused + 60 uncovered + 0 unaccounted + 3 adjudicated; **0 errors**, 62 typed divergences |
